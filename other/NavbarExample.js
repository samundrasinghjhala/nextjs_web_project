  ...
  return (
    <>
      <div className="min-h-10 bg-gray-100 min-w-screen">
        ...
        <div className="w-full text-gray-700 bg-white shadow-sm body-font" >
          <div className="container flex flex-col items-start p-6 mx-auto md:flex-row">
            ...
            <nav className="flex items-center justify-center text-base md:ml-auto">
              ...
              <a href="http://localhost:3005/home" className="mr-5 font-medium text-gray-900 hover:text-orange-500">Home</a>
              <a href="http://localhost:3005/blog" className="mr-5 font-medium text-gray-900 hover:text-orange-500">Blog</a>
              <a href="http://localhost:3005/about" className="mr-5 font-medium text-gray-900 hover:text-orange-500">About</a>
              <a href="http://localhost:3005/contact" className="font-medium text-gray-900 hover:text-orange-500">Contact</a>
            </nav>
